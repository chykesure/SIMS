...
export function DevSidebar() {
  const { currentPage, sidebarOpen, navigate, setSidebarOpen, toggleSidebar, logout } =
    useAppStore()
  ...
  return (
    <>
      ...
      >
        ...
        <div className={cn('border-t border-slate-800/80', collapsed ? 'px-2 py-2' : 'px-3 py-2')}>
          {collapsed ? (
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  onClick={logout}
                  className="flex w-full items-center justify-center rounded-lg px-2 py-2 text-slate-400 transition-colors hover:bg-red-500/10 hover:text-red-400"
                >
